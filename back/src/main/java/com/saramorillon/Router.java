...
public abstract class Router<P, R> extends CefMessageRouterHandlerAdapter {
    ...
    protected CefMessageRouter route() {
        CefMessageRouterConfig config = new CefMessageRouterConfig(this.name, this.name + "Abort");
        return CefMessageRouter.create(config, this);
    }
    ...
    public boolean onQuery(CefBrowser browser, CefFrame frame, long queryId, String request,
        ...
        P params = new Gson().fromJson(request, this.paramClass);
